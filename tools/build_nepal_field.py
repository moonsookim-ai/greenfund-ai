...
main = NEPAL/'index.html'
source = main.read_text(encoding='utf-8')
source, count = re.subn(r'<!-- FIELD_CONTACTS_START -->.*?<!-- FIELD_CONTACTS_END -->', '<!-- FIELD_CONTACTS_START -->\n'+contacts('ko')+'\n    <!-- FIELD_CONTACTS_END -->', source, flags=re.S)
assert count == 1
...
<link rel="canonical" href="https://greenfund.ai.kr/nepal/field/"><meta name="theme-color" content="#123c35">
...
(NEPAL/'field').mkdir(exist_ok=True)
(NEPAL/'field/index.html').write_text(page, encoding='utf-8')
print(f'Built contact cards and standalone field kit ({len(page.encode("utf-8")):,} bytes).')
