...
<section id="terrain" class="terrain-section" aria-labelledby="terrain-title">
  ...
  <div class="terrain-layout">
    <div class="terrain-map-column">
      ...
      <div class="terrain-frame" id="terrain-frame" aria-busy="true">
        ...
        <div class="terrain-map-scale"><span id="terrain-scale"></span><small>가로 방향 500m · 3D 기준</small></div>
      ...
      <p id="terrain-gestures" class="terrain-hint">좌우로 끌어 회전 · +/−로 확대·축소 · 보라 격자를 눌러 구역 확인 · 키보드 방향키 지원</p>
  ...
  <details id="terrain-method" class="terrain-method"><summary>이 3D 모델의 근거 · 무엇을 알 수 있고, 무엇을 알 수 없나요?</summary>
    <div class="terrain-method-grid"><article><h3>1. 실제 표고를 입체 지형으로</h3><p>SRTM 표고를 Mapzen Terrain Tiles에서 받아 지형을 구성했습니다. SRTM은 2000년 관측 기반으로, 이번 홍수 이후의 토사 높이나 붕괴 지형을 나타내지 않습니다. 원자료의 명목 품질은 약 90m이며 화면의 더 촘촘한 격자 간격이 실제 정확도를 높이지는 않습니다. 기본 높이 배율은 1배입니다.</p><p>지형의 녹색·갈색은 표고와 음영을 표현한 색입니다. 실제 위성 사진은 아래 ‘위성으로 본 홍수 전후’에서 볼 수 있습니다.</p></article>
...
if '<!-- TERRAIN_MODEL_START -->' in source:
    ...
    source=source.replace('<link rel="stylesheet" href="./briefing.css?v=2">','<link rel="stylesheet" href="./briefing.css?v=2">\n  <link rel="stylesheet" href="./terrain.css?v=1">')
    source=source.replace('</body>','<script type="module" src="./terrain.mjs?v=1"></script>\n</body>')
