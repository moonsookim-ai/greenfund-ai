...
MENU=(('nepal','/nepal/','네팔상황실'),('mangrove','/#app','맹그로브 성장 기록'),('emissions','/emissions/','우리 동네 온실가스 배출'))
...
def site_header(current, absolute=False):
    ...
    return f'''<header class="gp-site-header" lang="ko"><div class="gp-header-inner"><a class="gp-brand" href="{origin}/">GREEN <span>PROOF</span><small>환경재단이 운영하는 AI환경연구소</small></a><nav class="gp-main-nav" aria-label="주 메뉴">{links}</nav></div></header>'''
