"""One header for every AI환경연구소 page, including standalone briefs."""
...
def site_header(current, absolute=False):
    ...
    return f'''<header class="gp-site-header" lang="ko"><div class="gp-header-inner"><a class="gp-brand" href="{origin}/"><span>AI</span>환경연구소</a><nav class="gp-main-nav" aria-label="주 메뉴">{links}</nav></div></header>'''
